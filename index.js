window.addEventListener('DOMContentLoaded', () => {
  function aboutFunction() {
    ...
    const closeWrapAbout = document.getElementById('close-wrap-about');
    function wrapFunctionA() {
      if (wrapAbout.style.display === 'flex') {
        wrapAbout.style.display = 'none';
      } else {
        wrapAbout.style.display = 'flex';
      }
    }
    openWrapAbout.addEventListener('click', wrapFunctionA);
    closeWrapAbout.addEventListener('click', wrapFunctionA);
